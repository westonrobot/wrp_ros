...
#include "wrp_ros/peripheral/power_regulator_node.hpp"
...
PowerRegulatorNode::PowerRegulatorNode() {
  ...
  state_pub_ = nh_.advertise<wrp_ros::PowerRegulatorDeviceState>(
...
bool PowerRegulatorNode::HandleCommand(
    wrp_ros::PowerRegulatorControl::Request& req,
  ...
  if (req.channel == wrp_ros::PowerRegulatorControl::Request::CHANNEL_19V) {
    chn = PowerRegulatorV2::kChannel19V;
  } else if (req.channel ==
             wrp_ros::PowerRegulatorControl::Request::CHANNEL_12V) {
    chn = PowerRegulatorV2::kChannel12V;
  } else if (req.channel ==
             wrp_ros::PowerRegulatorControl::Request::CHANNEL_5VI) {
    chn = PowerRegulatorV2::kChannel5Vi;
  } else if (req.channel ==
             wrp_ros::PowerRegulatorControl::Request::CHANNEL_12VI) {
...
void PowerRegulatorNode::PublishCallback(
  ...
  wrp_ros::PowerRegulatorDeviceState state_msg;
