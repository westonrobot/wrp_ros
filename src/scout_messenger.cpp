...
#include "wrp_ros/scout_messenger.hpp"
...
void ScoutROSMessenger::SetupSubscription() {
  ...
  system_state_publisher_ = nh_->advertise<wrp_ros::SystemStateMsg>(
      "/mobilebase_system_status", 10);

  motion_state_publisher_ = nh_->advertise<wrp_ros::MotionStateMsg>(
      "/mobilebase_motion_status", 10);

  light_state_publisher_ = nh_->advertise<wrp_ros::LightControlType>(
      "/mobilebase_light_status", 10);

  actuator_state_publisher_ = nh_->advertise<wrp_ros::ActuatorStateMsg>(
  ...
  light_cmd_subscriber_ = nh_->subscribe<wrp_ros::LightControlType>(
...
void ScoutROSMessenger::PublishStateToROS() {
  ...
  wrp_ros::SystemStateMsg system_state_msg;
  wrp_ros::MotionStateMsg motion_state_msg;
  wrp_ros::LightControlType light_state_msg;
  wrp_ros::ActuatorStateMsg actuator_state_msg;
  ...
  switch (system_state.error_code) {
    case SYS_ERROR_CODE::SYS_ERROR_CODE_NONE: {
      system_state_msg.error_code =
          wrp_ros::SysErrorCode::SYS_ERROR_CODE_NONE;
      break;
    }
    case SYS_ERROR_CODE::SYS_ERROR_CODE_BATTERY_LOW_WARN: {
      system_state_msg.error_code =
          wrp_ros::SysErrorCode::SYS_ERROR_CODE_BATTERY_LOW_WARN;
      break;
    }

    case SYS_ERROR_CODE::SYS_ERROR_CODE_MOTOR_OVERHEAT_WARN: {
      system_state_msg.error_code =
          wrp_ros::SysErrorCode::SYS_ERROR_CODE_MOTOR_OVERHEAT_WARN;
      break;
    }

    case SYS_ERROR_CODE::SYS_ERROR_CODE_DRIVER_OVERHEAT_WARN: {
      system_state_msg.error_code =
          wrp_ros::SysErrorCode::SYS_ERROR_CODE_DRIVER_OVERHEAT_WARN;
      break;
    }

    case SYS_ERROR_CODE::SYS_ERROR_CODE_WARN_BIT_MASK: {
      system_state_msg.error_code =
          wrp_ros::SysErrorCode::SYS_ERROR_CODE_WARN_BIT_MASK;
      break;
    }

    case SYS_ERROR_CODE::SYS_ERROR_CODE_BATTERY_LOW_FAULT: {
      system_state_msg.error_code =
          wrp_ros::SysErrorCode::SYS_ERROR_CODE_BATTERY_LOW_FAULT;
      break;
    }

    case SYS_ERROR_CODE::SYS_ERROR_CODE_MOTOR_OVERHEAT_FAULT: {
      system_state_msg.error_code =
          wrp_ros::SysErrorCode::SYS_ERROR_CODE_MOTOR_OVERHEAT_FAULT;
      break;
    }

    case SYS_ERROR_CODE::SYS_ERROR_CODE_DRIVER_OVERHEAT_FAULT: {
      system_state_msg.error_code =
          wrp_ros::SysErrorCode::SYS_ERROR_CODE_DRIVER_OVERHEAT_FAULT;
      break;
    }

    case SYS_ERROR_CODE::SYS_ERROR_CODE_MOTOR_COMM_FAULT: {
      system_state_msg.error_code =
          wrp_ros::SysErrorCode::SYS_ERROR_CODE_MOTOR_COMM_FAULT;
      break;
    }

    case SYS_ERROR_CODE::SYS_ERROR_CODE_FAULT_BIT_MASK: {
      system_state_msg.error_code =
          wrp_ros::SysErrorCode::SYS_ERROR_CODE_FAULT_BIT_MASK;
      break;
    }
  }
  ...
  switch (system_state.operational_state) {
    case SYS_OPER_STATE::SYS_OPER_STATE_OPERATIONAL: {
      system_state_msg.operational_state =
          wrp_ros::SysOperState::SYS_OPER_STATE_OPERATIONAL;
      break;
    }
    case SYS_OPER_STATE::SYS_OPER_STATE_INITIALIZATION: {
      system_state_msg.operational_state =
          wrp_ros::SysOperState::SYS_OPER_STATE_INITIALIZATION;
      break;
    }

    case SYS_OPER_STATE::SYS_OPER_STATE_MAINTENANCE: {
      system_state_msg.operational_state =
          wrp_ros::SysOperState::SYS_OPER_STATE_MAINTENANCE;
      break;
    }

    case SYS_OPER_STATE::SYS_OPER_STATE_SOFTWARE_UPDATE: {
      system_state_msg.operational_state =
          wrp_ros::SysOperState::SYS_OPER_STATE_SOFTWARE_UPDATE;
      break;
    }

    case SYS_OPER_STATE::SYS_OPER_STATE_ESTOP_ACTIVATED: {
      system_state_msg.operational_state =
          wrp_ros::SysOperState::SYS_OPER_STATE_ESTOP_ACTIVATED;
      break;
    }

    case SYS_OPER_STATE::SYS_OPER_STATE_HARDWARE_FAULT: {
      system_state_msg.operational_state =
          wrp_ros::SysOperState::SYS_OPER_STATE_HARDWARE_FAULT;
      break;
    }
  }
  ...
  switch (system_state.ctrl_state) {
    case SYS_CTRL_STATE::SYS_CTRL_STATE_UNINITIALIZED: {
      system_state_msg.ctrl_state =
          wrp_ros::SysCtrlState::SYS_CTRL_STATE_UNINITIALIZED;
      break;
    }
    case SYS_CTRL_STATE::SYS_CTRL_STATE_STANDBY: {
      system_state_msg.ctrl_state =
          wrp_ros::SysCtrlState::SYS_CTRL_STATE_STANDBY;
      break;
    }

    case SYS_CTRL_STATE::SYS_CTRL_STATE_RC_HALT_TRIGGERED: {
      system_state_msg.ctrl_state =
          wrp_ros::SysCtrlState::SYS_CTRL_STATE_RC_HALT_TRIGGERED;
      break;
    }

    case SYS_CTRL_STATE::SYS_CTRL_STATE_RC_MANUAL_CONTROL: {
      system_state_msg.ctrl_state =
          wrp_ros::SysCtrlState::SYS_CTRL_STATE_RC_MANUAL_CONTROL;
      break;
    }

    case SYS_CTRL_STATE::SYS_CTRL_STATE_CAN_COMMAND_CONTROL: {
      system_state_msg.ctrl_state =
          wrp_ros::SysCtrlState::SYS_CTRL_STATE_CAN_COMMAND_CONTROL;
      break;
    }
  }
  ...
  switch (light_state.state.light_mode) {
    case LIGHT_MODE::LIGHT_MODE_BREATH: {
      light_state_msg.light_mode = wrp_ros::LightMode::LIGHT_MODE_BREATH;
      break;
    }
    case LIGHT_MODE::LIGHT_MODE_CONST_OFF: {
      light_state_msg.light_mode = wrp_ros::LightMode::LIGHT_MODE_CONST_OFF;
      break;
    }
    case LIGHT_MODE::LIGHT_MODE_CONST_ON: {
      light_state_msg.light_mode = wrp_ros::LightMode::LIGHT_MODE_CONST_ON;
      break;
    }
    case LIGHT_MODE::LIGHT_MODE_CUSTOM: {
      light_state_msg.light_mode = wrp_ros::LightMode::LIGHT_MODE_CUSTOM;
      break;
    }
  }
...
void ScoutROSMessenger::PublishSimStateToROS(float linear, float angular) {
  ...
  system_state_msg.ctrl_state =
      wrp_ros::SysCtrlState::SYS_CTRL_STATE_CAN_COMMAND_CONTROL;
  system_state_msg.error_code = wrp_ros::SysErrorCode::SYS_ERROR_CODE_NONE;
